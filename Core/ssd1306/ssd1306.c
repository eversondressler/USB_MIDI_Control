...
/*
 * Desenha 1 caractere no buffer da tela
...
char ssd1306_WriteChar(char ch, SSD1306_Font_t Font, SSD1306_COLOR color) {
    ...
    // Verifique se o caractere é válido
    if (ch < 32 || ch > 126)
        return 0;
    
    // Verifique o espaço restante na linha atual
    ...
    // O espaço atual já está ocupado
    SSD1306.CurrentX += Font.char_width ? Font.char_width[ch - 32] : Font.width;
    
    // Retornar char escrito para validação
    return ch;
}
